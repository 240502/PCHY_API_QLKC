...
namespace API_PCHY.Models.QUAN_TRI.QLKC_C4_GIAONHAN_KIM
{
    public class QLKC_C4_GIAONHAN_KIM_Manager
    {
        ...
        public string update_kyC1_PM_QLKC_C4_GIAONHAN_KIM(QLKC_C4_GIAONHAN_KIM_Model qLKC_C4_GIAONHAN_KIM)
        {
            try
            {
                string str_id = qLKC_C4_GIAONHAN_KIM.ID.ToString();
                string result = helper.ExcuteNonQuery("PKG_QLKC_THUAN.update_kyC1_PM_QLKC_C4_GIAONHAN_KIM", "p_ID",
                                                        "p_TRANG_THAI", "p_Error",
                                                       str_id, qLKC_C4_GIAONHAN_KIM.TRANG_THAI
                                                      );
                return result;
        ...
        public string update_kyC1_PQT_QLKC_C4_GIAONHAN_KIM(QLKC_C4_GIAONHAN_KIM_Model qLKC_C4_GIAONHAN_KIM)
        {
            try
            {
                string str_id = qLKC_C4_GIAONHAN_KIM.ID.ToString();
                string result = helper.ExcuteNonQuery("PKG_QLKC_THUAN.update_kyC1_PQT_QLKC_C4_GIAONHAN_KIM", "p_ID",
                                                        "p_TRANG_THAI", "p_Error",
                                                       str_id, qLKC_C4_GIAONHAN_KIM.TRANG_THAI
                                                      );
                return result;
        ...
        public string update_kyC2_PQT_C4_GIAONHAN_KIM(QLKC_C4_GIAONHAN_KIM_Model qLKC_C4_GIAONHAN_KIM)
        { 
            try
            {
                string str_id = qLKC_C4_GIAONHAN_KIM.ID.ToString();
                string result = helper.ExcuteNonQuery("PKG_QLKC_NGOCANH.update_kyC2_PQT_C4_GIAONHAN_KIM" ,"p_ID", "p_TRANG_THAI",
                                                         "p_Error",
                                                       str_id, qLKC_C4_GIAONHAN_KIM.TRANG_THAI
                                                      );
                return result;
         ...
         public string update_kyC2_PM_C4_GIAONHAN_KIM(QLKC_C4_GIAONHAN_KIM_Model qLKC_C4_GIAONHAN_KIM)
         { 
            try
            {
                string str_id = qLKC_C4_GIAONHAN_KIM.ID.ToString();
                string result = helper.ExcuteNonQuery("PKG_QLKC_NGOCANH.update_kyC2_PM_C4_GIAONHAN_KIM", "p_ID", "p_TRANG_THAI",
                                                         "p_Error",
                                                       str_id, qLKC_C4_GIAONHAN_KIM.TRANG_THAI
                                                      );
                return result;
        ...
        public string update_TL_PM_QLKC_C4_GIAONHAN_KIM(QLKC_C4_GIAONHAN_KIM_Model qLKC_C4_GIAONHAN_KIM)
        {
            try
            {
                string str_id = qLKC_C4_GIAONHAN_KIM.ID.ToString();
                string result = helper.ExcuteNonQuery("PKG_QLKC_NGOCANH.update_TL_PM_QLKC_C4_GIAONHAN_KIM", "p_ID", "p_TRANG_THAI",
                                                         "p_Error",
                                                       str_id, qLKC_C4_GIAONHAN_KIM.TRANG_THAI
                                                      );
                return result;
        ...
        public string update_TL_PQT_QLKC_C4_GIAONHAN_KIM(QLKC_C4_GIAONHAN_KIM_Model qLKC_C4_GIAONHAN_KIM)
        {
            try
            {
                string str_id = qLKC_C4_GIAONHAN_KIM.ID.ToString();
                string result = helper.ExcuteNonQuery("PKG_QLKC_NGOCANH.update_TL_PQT_QLKC_C4_GIAONHAN_KIM", "p_ID", "p_TRANG_THAI",
                                                         "p_Error",
                                                       str_id, qLKC_C4_GIAONHAN_KIM.TRANG_THAI
                                                      );
                return result;
        ...
        public string update_huyPM_QLKC_C4_GIAONHAN_KIM(QLKC_C4_GIAONHAN_KIM_Model qLKC_C4_GIAONHAN_KIM)
        {
            try
            {
                string str_id = qLKC_C4_GIAONHAN_KIM.ID.ToString();
                string result = helper.ExcuteNonQuery("PKG_QLKC_NGOCANH.update_huyPM_QLKC_C4_GIAONHAN_KIM", "p_ID", "p_TRANG_THAI",
                                                         "p_Error",
                                                       str_id, qLKC_C4_GIAONHAN_KIM.TRANG_THAI
                                                      );
                return result;
